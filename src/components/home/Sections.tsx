...
export default function Sections() {
  return (
    <>
      ...
      {/* --- Join / Google Form embed --- */}
      <section id="contact" className="py-32 sm:py-40 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
            <div className="md:col-span-4">
              <FadeIn>
                ...
                <p className="text-mid-gray leading-relaxed font-light mb-8">
                  Engineers, designers, and policy thinkers working on real problems
                  for real stakeholders. Fill out the form to get started.
                </p>
                <div className="flex items-center gap-6">
                  <a
                    ...
                    className="text-mid-gray hover:text-near-black transition-colors"
            ...
            <div className="md:col-span-7 md:col-start-6">
              <FadeIn direction="right">
                <div className="rounded-lg overflow-hidden border border-light-gray">
                  <iframe
                    src="https://docs.google.com/forms/d/e/1FAIpQLScPVRDHQLuMyNSJx53CyHA0kiXMSNf_bdQvhJC-ETylWopSNg/viewform?embedded=true"
                    width="100%"
                    height="800"
                    frameBorder="0"
                    marginHeight={0}
